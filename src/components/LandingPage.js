...
function LandingPage() {
  ...
  return (
    <div className="bg-black text-white relative overflow-hidden">
      ...
      <section className={`relative py-16 flex justify-between items-center bg-black ${showButtons ? 'animate-fade-in' : 'animate-fade-out'}`}>
      ...
      <section className={`h-[40vh] py-8 bg-black ${showFeatures ? 'animate-fade-in' : 'animate-fade-out'}`}>
      ...
      <section id="about" className={`h-[40vh] py-8 bg-black ${showAbout ? 'animate-fade-in' : 'animate-fade-out'}`}>
